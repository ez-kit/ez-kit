...
const apiSections = [
  {
    ...
    href: "/docs/api/ui",
    description:
      "General UI helpers for runtime checks, dimensions and small utility flows.",
  },
  {
    packageName: "@ez-kit/styling",
    href: "/docs/api/styling",
    description:
      "Styling primitives for class composition and CSS custom properties.",
  },
]
    ...
    <main className="docs">
      ...
      <div className="api-grid">
        {apiSections.map((section) => (
          <article key={section.packageName} className="api-card">
