  ...
  return (
    <main className="docs">
      ...
      <section>
        <h2>cx(...values)</h2>
        <p>
          Composes conditional class values from strings, arrays and object maps
          into one className string.
        </p>
        <pre>
...
const className = cx("btn", { "btn-active": true })`}</code>
      ...
      <section>
        ...
        <p>
          Builds a normalized CSS custom property object with -- prefix
          handling.
        </p>
      </section>
    </main>
