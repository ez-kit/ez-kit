...
herouiPackageFiles['/node_modules/use-sync-external-store/index.js'] = "export { useSyncExternalStore } from 'react'\n"
...
for (const entry of manifest) {
	...
	appFilesByExample[entry.id] =
		`import { ${entry.exportName} } from '${entryPath}'\n\nexport default function App() {\n\treturn <${entry.exportName} />\n}\n`
}

const header = `/* eslint-disable */\n// Generated by apps/docs/scripts/build-sandpack.mjs. Do not edit manually.\n\n`
// Pure-data modules lint clean on their own, so they omit the blanket eslint-disable
// (which `reportUnusedDisableDirectives` would otherwise flag as an unused directive).
const dataHeader = `// Generated by apps/docs/scripts/build-sandpack.mjs. Do not edit manually.\n\n`
...
const primitiveRegistryEntries = manifest.map((entry, index) => `\t'${entry.id}': Example${index},`).join('\n')
