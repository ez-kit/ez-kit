...
| ------------------ | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| **0. Preparation** | `develop`, still on v8 | extract `createTableOptions` as a pure function (`createTable` becomes a wrapper); remove destructuring and spreading of row/cell/column methods; rewrite indeterminate selection as an explicit predicate pair | full `verify`                                                               |
