...
import type { GridExpandingComponents } from '@ez-kit/data-grid-react'

/**
 * The `expanding` half of the kit's component contract, as its own module.
 *
 ...
 */
export const expandingComponents: GridExpandingComponents = { Chevron }
