...
import type { GridRowActionsComponents } from '@ez-kit/data-grid-react'

/**
 * The `rowActions` half of the kit's component contract, as its own module.
 *
 ...
 */
export const rowActionsComponents: GridRowActionsComponents = { ActionsCell }
