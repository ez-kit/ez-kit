...
import type { GridInfiniteComponents } from '@ez-kit/data-grid-react'

/**
 * The `infinite` half of the kit's component contract, as its own module.
 *
 ...
 */
export const infiniteComponents: GridInfiniteComponents = { LoadMoreRow }
