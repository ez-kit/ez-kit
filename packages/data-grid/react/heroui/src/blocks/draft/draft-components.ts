...
import type { GridDraftComponents } from '@ez-kit/data-grid-react'

/**
 * The `draft` half of the kit's component contract, as its own module.
 *
 ...
 */
export const draftComponents: GridDraftComponents = { DraftBar }
